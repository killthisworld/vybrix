...
export default function ReceivePage() {
  ...
  const shareToTwitter = () => {
    const text = `🛸 Just scored ${finalScore} points on Vybrix!\n\nCosmic pen pal meets retro arcade 👽\n\nCan you beat my score?`;
          ...
          <div style={{ height: 'calc(100dvh - 100px)' }} className="relative overflow-hidden">
            ...
            <div className="hidden md:block absolute bottom-4 left-4 z-30 bg-black/70 backdrop-blur px-4 py-2 rounded-lg border border-purple-400/30">
              ...
              <div className="text-cyan-400 text-xs space-y-0.5">
                <div><span className="bg-purple-600/50 px-2 py-0.5 rounded">W</span> Move Up (Hold)</div>
                <div><span className="bg-purple-600/50 px-2 py-0.5 rounded">S</span> Move Down (Hold)</div>
            ...
            <div className="text-center max-w-md w-full">
              ...
              {!showSurvey && (
                <div className="space-y-3">
                  ...
                  <button
                    onClick={resetGame}
                    className="w-full px-8 py-4 bg-gradient-to-r from-green-500 to-cyan-500 text-white text-xl font-bold rounded-lg hover:shadow-lg hover:shadow-green-500/50 transition-all transform hover:scale-105"
                  >
                    🎮 Play Again
                  </button>
